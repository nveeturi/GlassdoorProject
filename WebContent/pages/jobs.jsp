...
<link rel="stylesheet"
	href="../assets/plugins/animate-css/animate.min.css">
<link rel="stylesheet"
...
<script type="text/javascript"
	src="./assets/js/leaflet.markercluster-src.js"></script>
	...
	<div class="wrapper">
			...
			<div class="container">
				<h1 class="logo pull-left">
					<a href="index.jsp"> <img
						src="../assets/images/companies/glassdoor.png"> <span
						class="logo-title">glassdoor</span>
					</a>
				</h1>
				<!--//logo-->
		...
		<div class="blog container">
			<div class="container text-center jobsearch">
				<div class="row">
					<form class="signup-form" action="search" method="post" name="searchForm">
						&nbsp;&nbsp;&nbsp;
						<div class="row">
			...
			<div id="blog-list" class="blog-list section col-lg-6">
				...
				<article class="post">
					<c:forEach items="${joblist}" var="job">
									...
									<div class="row">
										<div class="col-lg-2">
											<img class="img-responsive"
												src="../assets/images/companies/opentable.png" alt="" />
										</div>
										<div class="col-lg-10">
											<ul class="list-unstyled">
												<li><h4>
												...
												<li><b>${job.companyName} - ${job.city}</b>&nbsp;<a
													href="#"><span class="glyphicon glyphicon-map-marker"></span></a></li>
												<li class="digest">${job.jobDescription}...<a href="#">details</a></li>
												<li class="digest"><a href="#">Overview</a> | <a
													href="#">Reviews</a> | <a href="#">Salaries</a></li>
											</ul>
										</div>
									</div>
								</li>
                        ...
                        <li><hr/></li> -->
							...
							<c:set var="pageCount" scope="page" value="${job.totalPages}" />
							<c:set var="link" scope="page" value="${job.totalPages}" />
				...
				<ul class="pagination">
					<li class="disabled"><a href="javascript:submitPage('1')">&laquo;</a></li>
					<li class="active"><a href="#">1<span class="sr-only">(current)</span></a></li>
					<c:if test="${pageCount gt 1}">
					<c:forEach begin="2" end="${pageCount }" varStatus="loop">
						<li><a href="javascript:submitPage('${loop.index}')">${loop.index}</a></li>
					</c:forEach>
			...
			<div id="blog-sidebar" class="blog-sidebar col-lg-4">
				<section class="map-section">
					<div id="map" class="mapdiv" style="width: 350px; height: 450px;"></div>
					<!--//map-->
				</section>
				<!--//map-->
			</div>
					...
					<div class="footer-col col-md-3 col-sm-4 col-md-offset-1 links">
						<div class="footer-col-inner">
							<ul class="list-unstyled">
								...
								<li><a href="#"><i class="fa fa-caret-right"></i>Post a
										Job</a></li>
							</ul>
						</div>
						<!--//footer-col-inner-->
			...
			<div class="container">
				<div class="row">
					<small class="copyright col-md-6 col-sm-6 col-xs-12">Copyright
						@ 2014 Glassdoor Practicum Team </small>
